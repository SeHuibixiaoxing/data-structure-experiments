...
public:
	...
	friend ConvexHull GetConvexHull(const std::vector<Point>& pointSet, std::vector<Point>& drawPointSet, std::vector<Point>& drawKeyPointSet, std::vector<std::pair<Point, Point>>& drawLineSet, int milliseconds);
	friend ConvexHull MergeSeparateConvexHull(ConvexHull& hull1_tmp, ConvexHull& hull2_tmp, std::vector<Point>& drawPointSet, std::vector<Point>& drawKeyPointSet, std::vector<std::pair<Point, Point>>& drawLineSet);
	friend ConvexHull GetConvexHull(std::vector<Point>& pointSet, int l, int r, std::vector<Point>& drawPointSet, std::vector<Point>& drawKeyPointSet, std::vector<std::pair<Point, Point>>& drawLineSet, int milliseconds);
